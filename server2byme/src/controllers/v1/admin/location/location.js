  ...
  getAll: async (req, res) => {
    try {
      ...
      const pipeline = [
        ...
        // Sort based on the provided "column" and "direction"
        {
        ...
        },
      {
        ...
        // Handle pagination and return the data along with the total count
        {
          $facet: {
            metadata: [{ $count: 'total' }], // Count total documents
            data: [{ $skip: skip }, { $limit: parseInt(pageSize, 10) }], // Paginate the results
          },
        },
      ];
