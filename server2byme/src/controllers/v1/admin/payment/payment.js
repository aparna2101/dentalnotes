...
const userObj = {
  create: async (req, res) => {
    try {
      ...
      const { inVoiceId, typeOfPayment, amountRecived } = req.body;
      ...
      let newInstance = await Payment.create(data);
      
      await Invoice.findOneAndUpdate(
        { _id: inVoiceId },
        { amountLeft: existing.amountLeft - newInstance.amountRecived }
      );
      //HERE WE WILL SEND THE MESSAGE TO ADMIN TO THE CUSTOMER THAT ONE PAYMENT IS RECEIVED
